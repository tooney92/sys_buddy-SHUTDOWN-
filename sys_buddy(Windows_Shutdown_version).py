...
for num in range(1, 12):
    time_dict.update({str(num)+'PM': count})
    count+=1
time_dict.update({'1AM':25, '12AM':24, '0AM':0})
...
def test_func():
    ...
    if start[-1] == 'AM' and close[-1] == 'PM':
        ...
        if int(close[1]) > int(start[1]):
            hour = time_dict[str(close[0])+'PM'] - am_time_dict[str(start[0])+'AM']
            ...
            hour = (time_dict[str(close[0])+'PM'] - am_time_dict[str(start[0])+'AM']) - 1
            result = 'hour(s) : %s, Minutes : %s'%(hour,minute)
            shutdown_time = (hour*3600) + (minute * 60)
            user_shutdown_time_label.config(text=str(result))
            main_shutdown_time.append(shutdown_time)
            ...
            minute = (int(close[1]) + 60) - int(start[1])
            hour = (time_dict[str(close[0])+'PM'] - am_time_dict[str(start[0])+start[-1]]) 
            result = 'hour(s) : %s, Minutes : %s'%(hour,minute)
            shutdown_time = (hour*3600) + (minute * 60)
            user_shutdown_time_label.config(text=str(result))
            main_shutdown_time.append(shutdown_time)
    ...
    if start[-1] == 'AM' and close[-1] == 'AM':
        ...
        if int(close[1]) > int(start[1]):
            hour = am_time_dict[str(close[0])+'AM'] - am_time_dict[str(start[0])+'AM']
            minute = abs(int(close[1]) - int(start[1]))
            result = 'hour(s) : %s, Minutes : %s'%(hour,minute)
            shutdown_time = (hour*3600) + (minute * 60)
            user_shutdown_time_label.config(text=str(result))
            ...
            minute = (int(close[1]) + 60) - int(start[1])
            hour = (am_time_dict[str(close[0])+'AM'] - am_time_dict[str(start[0])+'AM']) - 1
            result = 'hour(s) : %s, Minutes : %s'%(hour,minute)
            shutdown_time = (hour*3600) + (minute * 60)
            user_shutdown_time_label.config(text=str(result))
            main_shutdown_time.append(shutdown_time)
            ...
            minute = (int(close[1]) + 60) - int(start[1])
            hour = (am_time_dict[str(close[0])+start[-1]] - am_time_dict[str(start[0])+start[-1]])
            result = 'hour(s) : %s, Minutes : %s'%(hour,minute)
            shutdown_time = (hour*3600) + (minute * 60)
            user_shutdown_time_label.config(text=str(result))
            main_shutdown_time.append(shutdown_time)
        ...
        if int(close[1]) > int(start[1]):
            ...
            minute = (int(close[1]) + 60) - int(start[1])
            hour = (time_dict[str(close[0])+start[-1]] - time_dict[str(start[0])+start[-1]])
            result = 'hour(s) : %s, Minutes : %s'%(hour,minute)
            shutdown_time = (hour*3600) + (minute * 60)
            user_shutdown_time_label.config(text=str(result))
            main_shutdown_time.append(shutdown_time)
